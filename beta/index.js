...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'assets', true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/heart_pickup.png", "start": 0, "end": 4650, "audio": 0}, {"filename": "/assets/HUD.png", "start": 4650, "end": 5546, "audio": 0}, {"filename": "/assets/world_start.png", "start": 5546, "end": 15975, "audio": 0}, {"filename": "/assets/left_log.png", "start": 15975, "end": 17649, "audio": 0}, {"filename": "/assets/right_log.png", "start": 17649, "end": 19178, "audio": 0}, {"filename": "/assets/sword_attack.png", "start": 19178, "end": 20291, "audio": 0}, {"filename": "/assets/.DS_Store", "start": 20291, "end": 26439, "audio": 0}, {"filename": "/assets/collision.png", "start": 26439, "end": 26763, "audio": 0}, {"filename": "/assets/main_attack_ui.png", "start": 26763, "end": 28206, "audio": 0}, {"filename": "/assets/skullscore.png", "start": 28206, "end": 47663, "audio": 0}, {"filename": "/assets/health_bar.png", "start": 47663, "end": 48479, "audio": 0}, {"filename": "/assets/chest.png", "start": 48479, "end": 48930, "audio": 0}, {"filename": "/assets/crosshair.png", "start": 48930, "end": 49398, "audio": 0}, {"filename": "/assets/ghost.png", "start": 49398, "end": 50527, "audio": 0}, {"filename": "/assets/skullball.png", "start": 50527, "end": 51854, "audio": 0}, {"filename": "/assets/pot.png", "start": 51854, "end": 53436, "audio": 0}, {"filename": "/assets/character.png", "start": 53436, "end": 54070, "audio": 0}, {"filename": "/assets/collision_map.png", "start": 54070, "end": 54471, "audio": 0}, {"filename": "/assets/main_men.png", "start": 54471, "end": 75450, "audio": 0}, {"filename": "/assets/wall.png", "start": 75450, "end": 75923, "audio": 0}, {"filename": "/assets/skullgoal.png", "start": 75923, "end": 77353, "audio": 0}, {"filename": "/assets/skullscore.aseprite", "start": 77353, "end": 97430, "audio": 0}, {"filename": "/assets/skullscore_assets.aseprite", "start": 97430, "end": 99320, "audio": 0}, {"filename": "/assets/tooltip_move.png", "start": 99320, "end": 116454, "audio": 0}, {"filename": "/assets/potions.png", "start": 116454, "end": 116833, "audio": 0}], "remote_package_size": 116833, "package_uuid": "8be8d848-00ae-45cd-8bc0-49cf51c39577"});
...
var ASM_CONSTS = {
  22042: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 ...
 59491: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 60480: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 60573: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 61798: function() {return screen.width;},  
 61825: function() {return screen.height;},  
 61853: function() {return window.innerWidth;},  
 61885: function() {return window.innerHeight;},  
 61963: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 62097: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 62263: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
